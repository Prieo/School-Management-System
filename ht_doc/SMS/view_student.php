...
<br>	
           <table border="2px">
           	<tr>
           		<td style="padding: 20px; font-size: 15px;">UserName</td>
           		<td style="padding: 20px; font-size: 15px;">Email</td>
           		<td style="padding: 20px; font-size: 15px;">Phone</td>
           		<td style="padding: 20px; font-size: 15px;">Password</td>
	...
	while ($info=$result->fetch_assoc())
	{
		...
		?>
           	...
           	<tr>
           		...
           		<td style="padding: 20px;">
           		<?php 
           		echo "<a class='btn btn-danger' href='delete.php?student_id={$info['id']}'>Delete</a>"; 
        ?>
           		</td>
           		<td style="padding: 20px;">
           		<?php 
